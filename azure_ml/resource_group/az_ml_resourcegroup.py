...
def main():
    ...
    parser.add_argument("--subscription_id", type=str, default="5eab4ecc-5ecf-4754-802d-6da984293b70", help="Azure Subscription ID.")
    parser.add_argument("--resource_group_name", type=str, default="resource_group_py01", help="Resource Group Name.")
    parser.add_argument("--location", type=str, default="eastus", help="Azure Region (e.g., eastus, westus).")
